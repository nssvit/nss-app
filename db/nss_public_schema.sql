...
\restrict bJgM9jV4Qbhaq7Pjkx8tV0X5563dTMuKxoBHjDbL3RNoTdXisKDa70srYWsiZq3
...
--
-- Name: can_register_for_event(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.can_register_for_event(p_event_id uuid) RETURNS boolean
...
--
-- Name: FUNCTION can_register_for_event(p_event_id uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: create_event(text, text, timestamp without time zone, integer, uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.create_event(p_event_name text, p_event_description text, p_event_date timestamp without time zone, p_declared_hours integer, p_category_id uuid, p_event_location text DEFAULT NULL::text) RETURNS uuid
...
--
-- Name: get_attendance_summary(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_attendance_summary() RETURNS TABLE(event_id uuid, event_name text, event_date timestamp with time zone, category_name text, total_registered bigint, total_present bigint, total_absent bigint, attendance_rate numeric, total_hours bigint)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: FUNCTION get_attendance_summary(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: get_category_distribution(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_category_distribution() RETURNS TABLE(category_id integer, category_name text, event_count bigint, color_hex text, participant_count bigint, total_hours bigint)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: FUNCTION get_category_distribution(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: get_current_volunteer(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_current_volunteer() RETURNS TABLE(volunteer_id uuid, first_name text, last_name text, roll_number text, email text, branch text, year text, phone_no text, birth_date date, gender text, nss_join_year integer, address text, profile_pic text, is_active boolean, roles text[])
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
CREATE FUNCTION public.get_dashboard_stats() RETURNS TABLE(total_events bigint, active_volunteers bigint, total_hours bigint, ongoing_projects bigint)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: FUNCTION get_event_participants(event_uuid uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: get_events_with_stats(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_events_with_stats() RETURNS TABLE(event_id uuid, event_name text, event_description text, event_date timestamp with time zone, declared_hours integer, category_name text, category_color text, created_by_name text, participant_count bigint, total_declared_hours bigint, total_approved_hours bigint, is_active boolean)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: get_monthly_activity_trends(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_monthly_activity_trends() RETURNS TABLE(month text, month_number integer, year_number integer, events_count bigint, volunteers_count bigint, hours_sum bigint)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: FUNCTION get_monthly_activity_trends(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: get_top_events_by_impact(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_top_events_by_impact(limit_count integer DEFAULT 5) RETURNS TABLE(event_id uuid, event_name text, event_date timestamp with time zone, category_name text, participant_count bigint, total_hours bigint, impact_score text, event_status text)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: FUNCTION get_top_events_by_impact(limit_count integer); Type: COMMENT; Schema: public; Owner: -
--
...
CREATE FUNCTION public.get_user_stats() RETURNS TABLE(total_users integer, active_users integer, pending_users integer, admin_count integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: get_volunteer_hours_summary(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_volunteer_hours_summary() RETURNS TABLE(volunteer_id uuid, volunteer_name text, total_hours integer, approved_hours integer, events_count integer, last_activity timestamp without time zone)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: get_volunteer_participation_history(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_volunteer_participation_history(volunteer_uuid uuid) RETURNS TABLE(event_id uuid, event_name text, event_date timestamp with time zone, category_name text, participation_status text, hours_attended integer, attendance_date timestamp with time zone)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: FUNCTION get_volunteer_participation_history(volunteer_uuid uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_volunteers_with_stats(); Type: COMMENT; Schema: public; Owner: -
--
...
CREATE FUNCTION public.has_any_role(VARIADIC p_role_names text[]) RETURNS boolean
...
--
-- Name: FUNCTION has_any_role(VARIADIC p_role_names text[]); Type: COMMENT; Schema: public; Owner: -
--
...
CREATE FUNCTION public.has_role(p_role_name text) RETURNS boolean
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
DECLARE
    current_user_id UUID;
...
--
-- Name: FUNCTION has_role(p_role_name text); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: mark_event_attendance(uuid, uuid[], numeric, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.mark_event_attendance(p_event_id uuid, p_volunteer_ids uuid[], p_declared_hours numeric DEFAULT 0, p_recorded_by uuid DEFAULT NULL::uuid) RETURNS TABLE(success boolean, participants_added integer, message text)
    LANGUAGE plpgsql
    AS $$
DECLARE
  v_volunteer_id UUID;
...
--
-- Name: realtime_broadcast_changes(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.realtime_broadcast_changes() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  channel_name text;
...
--
-- Name: register_for_event(uuid, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.register_for_event(p_event_id uuid, p_declared_hours integer DEFAULT 0) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  volunteer_id uuid;
...
--
-- Name: sync_event_attendance(uuid, uuid[]); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.sync_event_attendance(p_event_id uuid, p_selected_volunteer_ids uuid[]) RETURNS TABLE(removed_count integer, message text)
    LANGUAGE plpgsql
    AS $$
DECLARE
  v_removed INTEGER;
...
--
-- Name: sync_event_categories_names(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.sync_event_categories_names() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: sync_events_names(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.sync_events_names() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: update_event_attendance(uuid, uuid[], uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_event_attendance(p_event_id uuid, p_volunteer_ids uuid[], p_recorded_by uuid DEFAULT NULL::uuid) RETURNS TABLE(success boolean, added integer, removed integer, total_present integer, message text)
    LANGUAGE plpgsql
    AS $$
DECLARE
  v_added INTEGER;
...
--
-- Name: TABLE event_participation; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE volunteers; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: event_summary; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: VIEW event_summary; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: role_management; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.role_management AS
...
--
-- Name: volunteer_summary; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.volunteer_summary AS
 SELECT v.id,
    v.first_name,
    v.last_name,
...
--
-- Name: VIEW volunteer_summary; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: event_categories event_categories_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: event_participation event_participation_event_id_volunteer_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_roles user_roles_volunteer_id_role_definition_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: volunteers volunteers_auth_user_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: volunteers volunteers_roll_number_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_event_participation_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_event_participation_volunteer; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_participation_event; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_participation_registration; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_participation_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_participation_volunteer; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_role_definitions_name; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_roles_role_def; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_roles_volunteer; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_volunteers_auth_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_volunteers_branch; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_volunteers_email; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_volunteers_roll_number; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_volunteers_year; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: event_categories event_categories_realtime_broadcast; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER event_categories_realtime_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.event_categories FOR EACH ROW EXECUTE FUNCTION public.realtime_broadcast_changes();


--
-- Name: event_participation event_participation_realtime_broadcast; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER event_participation_realtime_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.event_participation FOR EACH ROW EXECUTE FUNCTION public.realtime_broadcast_changes();


--
-- Name: events events_realtime_broadcast; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER events_realtime_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.events FOR EACH ROW EXECUTE FUNCTION public.realtime_broadcast_changes();


--
-- Name: event_categories set_event_categories_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_event_categories_updated_at BEFORE UPDATE ON public.event_categories FOR EACH ROW EXECUTE FUNCTION public.trigger_set_updated_at();
...
CREATE TRIGGER set_events_updated_at BEFORE UPDATE ON public.events FOR EACH ROW EXECUTE FUNCTION public.trigger_set_updated_at();


--
-- Name: event_participation set_participation_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_participation_updated_at BEFORE UPDATE ON public.event_participation FOR EACH ROW EXECUTE FUNCTION public.trigger_set_updated_at();


--
-- Name: role_definitions set_role_definitions_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_role_definitions_updated_at BEFORE UPDATE ON public.role_definitions FOR EACH ROW EXECUTE FUNCTION public.trigger_set_updated_at();
...
CREATE TRIGGER set_user_roles_updated_at BEFORE UPDATE ON public.user_roles FOR EACH ROW EXECUTE FUNCTION public.trigger_set_updated_at();


--
-- Name: volunteers set_volunteers_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_volunteers_updated_at BEFORE UPDATE ON public.volunteers FOR EACH ROW EXECUTE FUNCTION public.trigger_set_updated_at();


--
-- Name: event_categories sync_event_categories_names_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER sync_event_categories_names_trigger BEFORE INSERT OR UPDATE ON public.event_categories FOR EACH ROW EXECUTE FUNCTION public.sync_event_categories_names();


--
-- Name: events sync_events_names_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER sync_events_names_trigger BEFORE INSERT OR UPDATE ON public.events FOR EACH ROW EXECUTE FUNCTION public.sync_events_names();


--
-- Name: user_roles user_roles_realtime_broadcast; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER user_roles_realtime_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.user_roles FOR EACH ROW EXECUTE FUNCTION public.realtime_broadcast_changes();


--
-- Name: volunteers volunteers_realtime_broadcast; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER volunteers_realtime_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.volunteers FOR EACH ROW EXECUTE FUNCTION public.realtime_broadcast_changes();
...
--
-- Name: event_participation event_participation_recorded_by_volunteer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: event_participation event_participation_volunteer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: events events_created_by_volunteer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_roles user_roles_role_definition_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_roles user_roles_volunteer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: volunteers volunteers_auth_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: event_categories event_categories_public_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: event_participation; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.event_participation ENABLE ROW LEVEL SECURITY;

--
-- Name: event_participation event_participation_own_records; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: events events_create_authenticated; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: role_definitions role_definitions_read_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_roles user_roles_insert_system; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_roles user_roles_own_only; Type: POLICY; Schema: public; Owner: -
--
...
\unrestrict bJgM9jV4Qbhaq7Pjkx8tV0X5563dTMuKxoBHjDbL3RNoTdXisKDa70srYWsiZq3
