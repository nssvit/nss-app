          ...
          <div className={`flex-1 overflow-x-hidden overflow-y-auto main-content-bg mobile-scroll safe-area-bottom ${layout.getContentPadding()}`}>
            ...
            <div className="flex justify-center mt-8 md:mt-6 safe-area-bottom">
              <nav className={`flex ${layout.isMobile ? 'space-x-1' : 'space-x-2'}`}>
                <button className={`pagination-button ${layout.isMobile ? 'px-2 py-2 text-sm' : 'px-3 py-2 text-sm'} rounded-lg disabled:opacity-50 disabled:cursor-not-allowed pwa-button focus-visible`} disabled>
                  {layout.isMobile ? '‹' : 'Previous'}
                </button>
                <button className={`pagination-button active ${layout.isMobile ? 'px-3 py-2 text-sm' : 'px-3 py-2 text-sm'} rounded-lg pwa-button focus-visible`}>1</button>
                <button className={`pagination-button ${layout.isMobile ? 'px-3 py-2 text-sm' : 'px-3 py-2 text-sm'} rounded-lg pwa-button focus-visible`}>2</button>
                <button className={`pagination-button ${layout.isMobile ? 'px-3 py-2 text-sm' : 'px-3 py-2 text-sm'} rounded-lg pwa-button focus-visible`}>3</button>
                <button className={`pagination-button ${layout.isMobile ? 'px-2 py-2 text-sm' : 'px-3 py-2 text-sm'} rounded-lg pwa-button focus-visible`}>
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <main className="flex-1 flex flex-col header-bg">
        {/* Responsive Top Bar */}
        <header className={`flex items-center justify-between border-b border-gray-700/30 sticky top-0 z-20 header-bg safe-area-top ${
          ...
          <div className="flex items-center space-x-3 h-8">
            ...
            <div className="flex items-center space-x-3">
              ...
              <h1 className={`font-semibold text-gray-100 ${layout.isMobile ? 'text-base' : 'text-lg'}`}>
                NSS VIT {!layout.isMobile && (
          ...
          <div className={`flex items-center ${layout.isMobile ? 'space-x-2' : 'space-x-3'}`}>
            ...
            {activeLink === 'events' && (
              ...
              >
                <i className={`fas fa-plus ${layout.isMobile ? 'text-base' : 'fa-sm'}`}></i>
