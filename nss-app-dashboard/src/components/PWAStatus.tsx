      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {statusItems.map((item, index) => (
          <div key={index} className="text-center">
            <div
              className={`inline-flex items-center px-2.5 py-1.5 rounded-full text-xs font-medium ${item.bgColor} ${item.color} mb-2`}
            >
              {item.value}
            </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-800">
                You&apos;re currently offline. Some features may be limited, but
