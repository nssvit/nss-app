          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-4 text-sm text-gray-500 flex-wrap justify-center md:justify-start">
                {profileData.nss_join_year > 0 && (
                  <span>
                    <i className="fas fa-calendar mr-1"></i> NSS since{" "}
                    {profileData.nss_join_year}
                  </span>
                )}
                <span>
                    ...
                    {participationHistory.map((item, index) => (
                      ...
                      >
                        <div className="flex justify-between items-start mb-2">
                          <div>
                            ...
                            <p className="text-sm text-gray-400">
                              {new Date(item.event_date).toLocaleDateString()} • {item.category_name}
                            </p>
                          </div>
                          <span
                        ...
                        <div className="flex items-center gap-4 text-sm">
                          ...
                          <span
                            className={`${
                              item.participation_status === "attended" || item.participation_status === "present"
                                ? "text-green-400"
            ...
            {activeTab === "preferences" && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-gray-400 mb-4">
                    These preferences are stored locally and will be saved when the settings feature is fully implemented.
                  </p>
                  <div className="space-y-4">
