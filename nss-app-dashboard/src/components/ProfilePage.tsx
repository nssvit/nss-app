      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="card-glass rounded-xl p-6 mb-6">
          <div className={`flex ${layout.isMobile ? 'flex-col' : 'flex-row'} items-center gap-6`}>
            ...
            <div className={`flex-1 ${layout.isMobile ? 'text-center' : 'text-left'}`}>
              <h1 className={`${layout.isMobile ? 'text-xl' : 'text-2xl'} font-bold text-gray-100 mb-2`}>
                {profileData.name}
              </h1>
              <p className="text-lg text-gray-300 mb-2">{profileData.designation}</p>
              <p className="text-sm text-gray-400 mb-4">{profileData.department} • {profileData.location}</p>
              <div className="flex items-center gap-4 text-sm text-gray-500">
                <span><i className="fas fa-calendar mr-1"></i> Joined {profileData.joinDate}</span>
                <span><i className="fas fa-envelope mr-1"></i> {profileData.email}</span>
              </div>
            </div>
        ...
        <div className={`grid ${layout.isMobile ? 'grid-cols-2' : 'grid-cols-4'} gap-4 mb-6`}>
          <div className="card-glass rounded-xl p-4 text-center">
            <div className="text-2xl font-bold text-blue-400 mb-1">{stats.eventsOrganized}</div>
            <div className="text-sm text-gray-400">Events Organized</div>
          </div>
          <div className="card-glass rounded-xl p-4 text-center">
            <div className="text-2xl font-bold text-green-400 mb-1">{stats.volunteersManaged}</div>
            <div className="text-sm text-gray-400">Volunteers Managed</div>
          </div>
          <div className="card-glass rounded-xl p-4 text-center">
            <div className="text-2xl font-bold text-purple-400 mb-1">{stats.hoursLogged}</div>
            <div className="text-sm text-gray-400">Hours Logged</div>
          </div>
          <div className="card-glass rounded-xl p-4 text-center">
            <div className="text-2xl font-bold text-orange-400 mb-1">{stats.achievements}</div>
          ...
          <div className="p-6">
            ...
            {activeTab === 'activity' && (
              <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    {recentActivity.map((activity, index) => (
                      <div key={index} className="flex items-center space-x-4 p-3 bg-gray-800/30 rounded-lg">
                        <div className={`w-10 h-10 rounded-lg bg-gray-700/50 flex items-center justify-center ${activity.color}`}>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-100 mb-4">Activity Chart</h3>
                  <div className="h-64 bg-gray-800/30 rounded-lg flex items-center justify-center">
                    <div className="text-center text-gray-500">
                      ...
                      <p className="text-sm mt-1">Integration with Chart.js coming soon</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeTab === 'preferences' && (
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-100 mb-4">Display Preferences</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
