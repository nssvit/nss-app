  ...
  const users: User[] = [
    {
      ...
      joinDate: "Jan 2020",
      permissions: ["all"],
      avatar: "https://res.cloudinary.com/du6zyqqyw/image/upload/f_auto,q_auto,w_32/v1740560606/img/2024-2025/team/rakshaksood.jpg"
    },
    {
      id: 2,
      ...
      <div className="card-glass rounded-xl overflow-hidden">
          ...
          <div className={`grid ${layout.isMobile ? 'grid-cols-1' : 'grid-cols-7'} gap-4 items-center`}>
            {!layout.isMobile && (
              <>
                ...
                <div className="text-sm font-medium text-gray-300">Last Login</div>
        ...
        <div className="divide-y divide-gray-700/30">
          {filteredUsers.map((user) => (
            <div key={user.id} className="px-4 py-3 hover:bg-gray-800/20 transition-colors">
              {layout.isMobile ? (
                // Mobile Layout
