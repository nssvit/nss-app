    ...
    <div className={`flex-1 overflow-x-hidden overflow-y-auto main-content-bg mobile-scroll safe-area-bottom ${layout.getContentPadding()}`}>
      ...
      <div className="card-glass rounded-xl overflow-hidden">
        ...
        <div className="bg-gray-800/30 px-4 py-3 border-b border-gray-700/30">
          <div className={`grid ${layout.isMobile ? 'grid-cols-1' : 'grid-cols-8'} gap-4 items-center`}>
            {!layout.isMobile && (
              <>
              ...
              {layout.isMobile ? (
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <h4 className="font-medium text-gray-200">{volunteer.name}</h4>
                ...
                <div className="grid grid-cols-8 gap-4 items-center">
                  ...
                  <div className="col-span-2 flex items-center space-x-3">
                    ...
                    />
                    <div>
                      <div className="font-medium text-gray-200 text-sm">{volunteer.name}</div>
