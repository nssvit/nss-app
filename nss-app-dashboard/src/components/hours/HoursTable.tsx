        ...
        <div key={p.id} className="px-4 py-3 hover:bg-gray-800/20 transition-colors">
          {isMobile ? (
              ...
              <div className="flex items-center space-x-3">
                {filter === 'pending' && (
                  <input
                    ...
                    onChange={() => onSelectItem(p.id)}
                  />
                )}
                <Image
                  src={p.volunteer?.profilePic || '/icon-192x192.png'}
            ...
            <div className="grid grid-cols-7 gap-4 items-center">
              ...
              <div
                className={`${filter === 'pending' ? 'col-span-2' : 'col-span-3'} flex items-center space-x-3`}
              >
                <Image
                  src={p.volunteer?.profilePic || '/icon-192x192.png'}
                  alt={p.volunteer ? `${p.volunteer.firstName} ${p.volunteer.lastName}` : 'Unknown'}
              ...
              <div className="col-span-2">
                ...
                <div className="text-xs text-gray-500">
                  {formatDate(p.event?.startDate || null)}
                </div>
              </div>
              <div>
