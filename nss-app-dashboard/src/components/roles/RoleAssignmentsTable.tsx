...
export function RoleAssignmentsTable({ userRoles, loading, isMobile, onRevoke }: RoleAssignmentsTableProps) {
  if (loading) {
    return (
          ...
          {isMobile ? (
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <Image src={ur.volunteer?.profile_pic || '/icon-192x192.png'}
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <button onClick={() => onRevoke(ur.id)} className="text-red-400 hover:text-red-300 p-1">
            ...
            <div className="grid grid-cols-5 gap-4 items-center">
              ...
              <div className="flex space-x-2">
                <button onClick={() => onRevoke(ur.id)} className="text-gray-400 hover:text-red-400 p-1 rounded" title="Revoke role">
